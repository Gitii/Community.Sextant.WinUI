...
public class RedViewModel : ViewModelBase
{
    ...
    public RedViewModel(IViewStackService viewStackService) : base(viewStackService)
    {
        ...
        PopPage = ReactiveCommand.CreateFromObservable(
