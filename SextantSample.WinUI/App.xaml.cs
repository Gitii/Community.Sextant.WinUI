...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        Locator.CurrentMutable
            ...
            .RegisterViewForNavigation(
                () => new SecondModalView(),
                () =>
                    new SecondModalViewModel(
                        Locator.Current.GetService<IParameterViewStackService>()!
                    )
            )
            .RegisterViewModel(
                () => new GreenViewModel(Locator.Current.GetService<IViewStackService>()!)
            )
            .RegisterConstant<IDialogManager>(new DialogManager());
    }
    ...
    protected override void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        Locator.CurrentMutable.Register<Window>(() => _window);
        _window!.Activate();
    }
